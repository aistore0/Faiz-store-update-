...
module.exports = alpha = async (alpha, m, chatUpdate, store, antilink, antiwame, antilink2, antiwame2, set_welcome_db, set_left_db, set_open, set_close, _welcome, _left) => {
    try {
        ...
        const isCreator = ["6285383056042@s.whatsapp.net", botNumber, ...global.owner].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(m.sender)
        ...
        const getStyle = (style, style2) => {
            let listt = `*${style2} Yg Lu Masukin Itu Salah*\n\n_Ini List ${style2} Yg Benar, Total_ *${style}* _${style2}_\n\n`
            no = 0
        ...
        if (isAntiLink) {
            if (budy.match(`chat.whatsapp.com`)) {
                ...
                if (!isBotAdmins) return reply(`Upsss... Gajadi, Soalnya Bot Bukan Admin`)

...
global.mess = {
    ...
    wait: '_⌛ bentar_',
    admin: '_Fitur ni khusus untuk admin_',
    botNotAdmin: '_Bot nya harus jadi admin dulu_',
    owner: '_fitur ini untuk pembuat bot_',
    group: '_Fitur ini cuman ada di group_',
}
global.butwel =  [{
   buttonId: '.menu',
   buttonText: {
